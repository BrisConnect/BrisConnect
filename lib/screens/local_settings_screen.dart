...
class _LocalSettingsScreenState extends State<LocalSettingsScreen> {
  ...
  void initState() {
    super.initState();
    _notificationsEnabled = LocalAuth.areNotificationsEnabled();
  }

  Future<void> _toggleNotifications(bool value) async {
    setState(() => _isSaving = true);

    final success = await LocalAuth.setNotificationsEnabled(value);
    ...
    if (success) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            value
                ? 'Event reminders enabled for your Local account.'
                : 'Event reminders disabled for your Local account.',
          ),
                            ...
                            children: [
                              ...
                              Text(
                                _notificationsEnabled
                                    ? 'You will receive reminders for followed events'
                                    : 'Event reminders are currently turned off',
