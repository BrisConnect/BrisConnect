...
/// Screen where a local business owner views and purchases promotion plans.
class PromotionPlansScreen extends StatefulWidget {
  final String? initialBusinessId;

  const PromotionPlansScreen({super.key, this.initialBusinessId});
...
class _PromotionPlansScreenState extends State<PromotionPlansScreen> {
  ...
  Future<void> _loadOwnerBusinesses() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() => _isLoadingBusinesses = false);
      debugPrint('[PromotionPlansScreen] Failed to load businesses: $e');
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Promote Your Business'),
              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (docs.isEmpty) {
                    return const Center(
                      child: Text(
                        'No promotion plans are available right now.',
                        style: TextStyle(color: AppPalette.mutedText),
                      ),
                    );
                  }
                  ...
                  final plans = docs.map((d) {
                    return PromotionPlan.fromFirestore(
      ...
      return Container(
        ...
        child: const Row(
          children: [
            ...
            Expanded(
              child: Text(
                'You need an active business listing before you can purchase a promotion plan.',
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              runSpacing: 8,
              children: [
                _buildMetaChip(Icons.timelapse_rounded, durationLabel),
