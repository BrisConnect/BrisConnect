...
class _ApprovedAttractionsMapScreenState
  ...
  void _toggleCategory(AttractionCategory cat) {
    setState(() {
      ...
      if (_selected != null && _selectedCategories.isNotEmpty) {
        ...
        final bool stillVisible = _selectedCategories
            .any((c) => selCat == c.label.toLowerCase());
            ...
            children: [
              ...
              FlutterMap(
                ...
                children: [
                  ...
                  MarkerLayer(
                    markers:
                        filtered.map(_buildMarker).toList(growable: false),
                  ),
                ],
              ),
  ...
  Marker _buildMarker(ApprovedAttraction item) {
    ...
    return Marker(
      ...
      child: GestureDetector(
        key: Key('attraction-marker-${item.id}'),
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            const Icon(Icons.info_outline, color: AppPalette.deepBlue, size: 18),
